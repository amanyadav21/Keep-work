...
// import { useSearchParams, useRouter } from 'next/navigation'; // useSearchParams no longer needed for initial load
import { useRouter } from 'next/navigation'; // Still needed for router.back()
...
interface AIAssistantPageContentProps {
  initialTaskDescription: string | null;
}

export default function AIAssistantPageContent({ initialTaskDescription }: AIAssistantPageContentProps) {
  ...
  // Use initialTaskDescription from props
  const taskDescriptionFromUrl = initialTaskDescription;

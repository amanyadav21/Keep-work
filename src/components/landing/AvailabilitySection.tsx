      ...
      <style jsx global>{`
        ...
        /* Custom 'xs' breakpoint styles for Tailwind JIT */
         @media (min-width: 480px) { 
          ...
          .xs\\:text-4xl { font-size: 2.25rem !important; line-height: 2.5rem !important; } /* For title */
          .xs\\:text-base { font-size: 1rem !important; line-height: 1.5rem !important; } /* For subtitle */
          .xs\\:mb-8 { margin-bottom: 2rem !important; } /* Subtitle and icon grid mb */
          .xs\\:mb-10 { margin-bottom: 2.5rem !important; } /* Icon grid mb */
          .xs\\:max-w-xs { max-width: 20rem !important; } /* Icon grid max-width */
        }
      `}</style>
    </section>
  );

  ...
  return (
    <Separator
      ...
      className={cn(
        ...
        state === 'collapsed' && collapsible === 'icon' && "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        state === 'collapsed' && collapsible === 'icon' && "-mt-8 opacity-0",
        className
      )}
      {...props}
    />
...
>(
  (
    ...
    if (!mounted || !tooltip || (isMobile === false && state === "expanded" && collapsible !== "icon")) { 
